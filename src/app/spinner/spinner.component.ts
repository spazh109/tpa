    ...
    template:
     ...
     <div class="spinner-message-container" aria-live="assertive" aria-atomic="true">
       ...
       <modal #quitDialog  (onClose) = "quitDialogClose()" [hideCloseButton]="false"
          ...
          <modal-footer>
              <button class="btn btn-default btn-rounded pull-xs-left" (click)="quitDialog.close()">Cancel</button>
       ...
       <modal #yesDialog  (onClose) = "yesDialogClose()" >
          ...
          <modal-footer>
              <button class="btn btn-default btn-rounded pull-xs-left" (click)="yesDialog.close()">Cancel</button>
